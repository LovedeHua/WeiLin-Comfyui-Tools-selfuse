...
export default {
    promptBox: {
        ...
        addLineToken: "添加换行符",
        searchTags: "搜索标签...",
        searchMatches: "共 {n} 个匹配",
        selectedCount: "选中 {n} 个标签",
        settings: {
            title: '设置',
            cancel: '取消',
            save: '保存',
            ...
            disableAutoRandom: '屏蔽节点 auto_random 开关',
            disableAutoRandomDesc: '开启后：隐藏节点上的 auto_random 控件并强制关闭它，已保存的工作流中残留的 auto_random=true 会在执行时按 false 处理。仅影响该控件，右侧工具栏的随机标签功能不受影响。保存后需重新加载页面（Ctrl+R）生效。',
            ...
            enableTagTips: '显示 Tag 操作提示浮窗（点击 Tag 时弹出）',
            ...
            setting_history_limit: "历史记录上限",
            history_limit_label: "历史上限条数（0 为不限制）",
            history_limit_placeholder: "例如 500",
            history_limit_desc: "保存历史时若超出上限，将自动清理最旧的记录；相同内容的提示词会刷新时间置顶而不会重复保存。",
    ...
    theme: {
        toggle: '切换主题',
        followComfy: '跟随 ComfyUI 主题（点击切换为强制暗色）',
        forceDark: '强制暗色（点击切换为强制亮色）',
        forceLight: '强制亮色（点击恢复跟随 ComfyUI）'
    },
    common: {
        "confirmDelete": "确认删除",
        "delete": "删除",
    ...
    tagManager: {
        ...
        "filterPlaceholder": "过滤当前分组的标签...",
        "globalSearch": "全局搜索",
        "filterCurrent": "本组过滤",
        "globalSearchTip": "跨分组搜索所有标签，点击结果跳转",
        "filterCurrentTip": "仅过滤当前分组的标签列表",
        "noResults": "未找到相关结果",
    ...
    "message": {
        ...
        "quickFavoriteEmpty": "提示词为空，无法收藏",
        "quickFavoriteNameRequired": "请输入收藏名称",
        "addFavoriteIsExist": "该收藏已存在，不再重复添加",
        "error": "错误",
        "editNameExist": "名称已存在",
        "moveSuccess": "移动成功",
        "moveFailed": "移动失败",
    ...
    history: {
        ...
        "search_favorites_placeholder": "搜索收藏...",
        "date_from": "开始日期",
        "date_to": "结束日期",
        ...
        "dialog": {
            ...
            "save_hint": "Ctrl+Enter 快速保存",
            "follow_lora": "跟随 Lora",
            "no_lora": "无跟随 Lora",
            "lora_search_placeholder": "搜索 Lora 名称添加",
            "lora_missing": "文件不存在",
