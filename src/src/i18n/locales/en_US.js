...
export default {
    promptBox: {
        ...
        oneClickRandomTag: 'Random Tag',
        oneClickCleanAll: 'Clear All',
        oneClickClearDisabled: 'Clear Disabled',
        clearDisabledSuccess: 'All disabled tags cleared',
        randomTagSettings: 'Random Tag Rules',
        oneClickTranslate: "Translate All Tags",
        showDeleteButton: "Show Delete Button",
        hideDeleteButton: "Hide Delete Button",
        modelWeight: "Model Weight",
        textWeight: "Text Weight",
        weightSync: "Sync Weights",
        enableTag: "Enable",
        disableTag: "Disable",
        favour: "Favour",
        ...
        settings: {
            ...
            setting_auto_complete_limit: 'Autocomplete Settings',
            show_auto_limit: 'Autocomplete Limit',
            setting_history_limit: 'History Limit',
            history_limit_label: 'Max history entries (0 = unlimited)',
            history_limit_placeholder: 'e.g. 500',
            history_limit_desc: 'When saving exceeds the limit, the oldest records are cleaned up automatically. Identical prompts refresh their timestamp and move to the top instead of creating duplicates.',
            ...
            disableAutoRandom: 'Hide the auto_random switch on nodes',
            disableAutoRandomDesc: 'When enabled: hides the auto_random widget on nodes and forces it off. Any auto_random=true left in saved workflows is treated as false at execution time. This only affects that widget — the random tag features in the toolbar are unaffected. Reload the page (Ctrl+R) after saving.',
            ...
            enableTagTips: 'Show tag tips popup (when clicking a tag)',
    ...
    theme: {
        toggle: 'Switch Theme',
        followComfy: 'Following ComfyUI theme (click to force dark)',
        forceDark: 'Forced dark (click to force light)',
        forceLight: 'Forced light (click to follow ComfyUI)'
    },
    lora: {
    ...
    tagManager: {
        ...
        "filterPlaceholder": "Filter tags in current group...",
        "globalSearch": "Global",
        "filterCurrent": "Filter",
        "globalSearchTip": "Search all tags across groups, click result to jump",
        "filterCurrentTip": "Only filter tags in the current group",
    ...
    loraManager: {
        ...
        enableAllLora: "Enable All",
        disableAllLora: "Disable All",
        defaultMode: "Default",
    ...
    "message": {
        ...
        "quickFavoriteEmpty": "Prompt is empty, nothing to save",
        "quickFavoriteNameRequired": "Please enter a favorite name",
        "addFavoriteIsExist": "This favorite already exists",
        "error": "Error",
    ...
    history: {
        ...
        "switch_to_favorites": "Switch to favorites window",
        ...
        "dialog": {
            ...
            "token_count": "{n} tokens",
            "save_hint": "Ctrl+Enter to save",
            "follow_lora": "Attached Lora",
            "no_lora": "No attached Lora",
            "lora_search_placeholder": "Search Lora by name to add",
            "lora_missing": "File not found",
